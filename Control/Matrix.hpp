...
class QMATHDLL_API Matrix : public MatrixBase<T>
{
 public:
...
QMATHDLL_API Matrix<nCols, nRows, T> transpose(const Matrix<nRows, nCols, T> &matrix);
 //  return The transpose of the matrix \a matrix.

template<int size, class T>
QMATHDLL_API Matrix<size, size, T> inverse(const Matrix<size, size, T> &m);
...
template<int size, class T> 
QMATHDLL_API T determinant ( const Matrix <size, size, T> &matrix);
 //  return  Determinant of a matrix.
 
template<int size, class T> 
QMATHDLL_API T trace( const Matrix <size, size, T> &matrix);
 //  return Trace of a size x size matrix.

template<int size, class T>
QMATHDLL_API Matrix<size, size, T> unitMatrix();
...
QMATHDLL_API Matrix<r1, c2, T> operator* (const Matrix<r1, c1r2, T> &m1, const Matrix<c1r2, c2, T> &m2);
...
QMATHDLL_API T operator* (const Matrix<1, c1r2, T> &m1, const Matrix<c1r2, 1, T> &m2);
